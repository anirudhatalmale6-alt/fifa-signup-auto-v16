...
(function() {
  ...
  const DEFAULT_MATCH_CONFIG = [
    { matchNumber: 1, category: 3, quantity: 2 },
    { matchNumber: 5, category: 3, quantity: 2 },
    { matchNumber: 19, category: 3, quantity: 2 },
    { matchNumber: 24, category: 3, quantity: 2 },
    { matchNumber: 28, category: 3, quantity: 2 },
    { matchNumber: 32, category: 3, quantity: 2 },
    { matchNumber: 33, category: 3, quantity: 2 },
    { matchNumber: 43, category: 3, quantity: 2 },
    { matchNumber: 45, category: 3, quantity: 2 },
    { matchNumber: 53, category: 3, quantity: 2 },
    { matchNumber: 66, category: 3, quantity: 2 },
    { matchNumber: 70, category: 3, quantity: 2 },
    { matchNumber: 76, category: 3, quantity: 2 },
    { matchNumber: 79, category: 3, quantity: 2 },
    { matchNumber: 83, category: 3, quantity: 2 },
    { matchNumber: 86, category: 3, quantity: 2 },
    { matchNumber: 90, category: 3, quantity: 2 },
    { matchNumber: 92, category: 3, quantity: 2 },
    { matchNumber: 93, category: 3, quantity: 2 },
  ];
  ...
  // Format: "5,11,18,24" or "5,11,18,24"
