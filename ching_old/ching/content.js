...
(function() {
  ...
  const DEFAULT_MATCH_CONFIG = [
    { matchNumber: 1, category: 3, quantity: 3 },
    { matchNumber: 5, category: 3, quantity: 3 },
    { matchNumber: 19, category: 3, quantity: 3 },
    { matchNumber: 24, category: 3, quantity: 3 },
    { matchNumber: 28, category: 3, quantity: 3 },
    { matchNumber: 32, category: 3, quantity: 3 },
    { matchNumber: 33, category: 3, quantity: 3 },
    { matchNumber: 43, category: 3, quantity: 3 },
    { matchNumber: 45, category: 3, quantity: 3 },
    { matchNumber: 49, category: 3, quantity: 3 },
    { matchNumber: 66, category: 3, quantity: 3 },
    { matchNumber: 79, category: 3, quantity: 3 },
    { matchNumber: 92, category: 3, quantity: 3 },
  ];
